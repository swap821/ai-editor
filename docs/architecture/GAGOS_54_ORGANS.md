...
> **SUPERSEDED COUNTS BELOW — current status is 12 green / 42 yellow as of
> 2026-09-01 (`9381121`).** The 2026-09-01 recount first took the ledger to
> 5 green / 49 yellow; wave 1 of the restoration then returned organs 9, 19, 33,
> 41, 42, 47 and 50 to green by citing C3/C4/C5 proofs that execute in the
> gate's own run — see `release/organ-ledger/2026-09-01-wave1-restoration.md`.
> Every green/yellow tally in the dated narrative
...
- **Counts:** 12 green / 42 yellow / 54 total
- **Source ledger sha256:** `3e4f0c39ae56cd39f9569b40c369f0fb754e93a702a798ca4028fa8bea84f09d`
