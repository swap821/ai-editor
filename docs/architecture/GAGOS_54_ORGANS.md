...
- **Source ledger sha256:** `107a1bc03385bd9cb711d5843c3955b343d115e4024f8c72679af4730f2318e6`
...
| 23 | Release Conformance Organ | `ReleaseConformanceAuthority` | Phase 6 gate — organ 23 stays yellow until every below-organ is honestly green |
| 44 | Golden Mission and Endurance Evaluation | `GoldenMissionEnduranceAuthority` | Outside-machine — cloud-provider credentials barred; cannot invent cloud golden-cohort live evidence |
| 46 | Constitutional Learning Organ | `ConstitutionalLearningAuthority` | no Ollama — live constitutional learning path needs live Ollama and/or Outside-machine cloud<br>TWO agent red-team campaigns (2026-08-08, 2026-08-09) confirmed 24 bypasses of this organ's screening layer; the second campaign found more severe defects in the FIX than the first found in the original code. All remediated and pinned by tests/test_governance_red_team_corpus.py (470 cases), but the pattern is now established rather than suspected.<br>ROOT FINDING: marker screening over prose is the wrong control, not an under-tuned one. Each campaign closes the shapes it found and leaves the unbounded space of paraphrase and encoding untouched. Closing it properly means expressing the approval mechanism as typed data, so 'who ratifies' cannot be written in a sentence at all — an architectural decision reserved for the operator. See release/organ-46/2026-08-09-second-red-team-campaign.md.<br>independent human red-team still absent by design |
