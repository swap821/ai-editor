...
- **C6**: focused_tests not executed here (needs vitest): frontend/src/workbench/SovereignStatePanel.organ51.test.jsx -- pass --frontend-junit or --allow-unexecuted-frontend
