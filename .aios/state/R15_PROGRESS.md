...
- **Exact next action:** Commit/push this slice, verify hosted CI/CodeQL on its source tip, then begin truthful default operational API/durable repository convergence; do not start R16.
