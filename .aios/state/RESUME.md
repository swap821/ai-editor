...
**Single Next Action:** Commit and push the current-master merge, then verify the fresh CodeQL check, release-authority, review-thread state, and GitHub mergeability; do not merge to `master`.
