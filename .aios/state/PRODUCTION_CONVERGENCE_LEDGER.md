...
Commit and push the PR #141 CodeQL remediation, then verify the fresh CodeQL check, release-authority, review-thread state, and GitHub mergeability. Do not merge to `master` or infer production readiness from green CI alone.
