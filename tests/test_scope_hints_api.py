...
def test_scope_hints_recommends_files_within_allowed_scope(
...
def test_scope_hints_never_recommends_files_outside_allowed_list(
    client, tmp_path, monkeypatch
) -> None:
    ...
    resp = client.post(
        "/api/v1/projects/scope-hints",
        json={
            "goal": "unrelated_symbol_for_the_goal_text",
            "allowedFiles": ["login.py"],
        },
    )
...
def test_scope_hints_rejects_traversal_outside_workspace(
    client, tmp_path, monkeypatch
) -> None:
