...
def test_real_installed_set_picks_qwen_coder_3b() -> None:
    # The operator's actual `ollama list` (sans the embedder): the agent should
    # auto-select the coder model, not llama3.1:8b / llama3.2:3b / the base model.
    installed = [
        "qwen2.5-coder:3b",
        "llama3.2:3b",
    ...
    assert select_model(installed) == "qwen2.5-coder:3b"
