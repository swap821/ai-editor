...
class ConfidenceUpdater:
    ...
    def record_failure(self, skill: SkillContract, reason: Literal["verification", "applicability", "version_drift", "human_correction", "rollback", "side_effects"]) -> SkillContract:
